...
var QR_DEFAULTS=[{l:"Nugget Protocol",e:"\uD83E\uDDF8",g:["kevin","jenna","madi","jack","emmy"],m:"kid-peace",meals:["breakfast","brunch","lunch","dinner"]},{l:"Zero Regrets",e:"\uD83D\uDD25",g:["kevin"],m:"trash-goblin",meals:["dinner","latenight"]},{l:"Sugar Rush",e:"\uD83C\uDF6A",g:["kevin","jenna"],m:"sweet-treat",meals:[]},{l:"Kevin After Dark",e:"\uD83C\uDF1C",g:["kevin"],m:"trash-goblin",meals:["latenight"]},{l:"Salad Era",e:"\uD83E\uDD57",g:["kevin","jenna"],m:"healthy",meals:["dinner","lunch"]},{l:"Just Feed Me",e:"\u26A1",g:["kevin"],m:"safe-default",meals:["breakfast","brunch","lunch"]},{l:"Slow Start",e:"\uD83D\uDECB\uFE0F",g:["kevin","jenna"],m:"comfort",meals:["breakfast","brunch"]},{l:"Full House Mode",e:"\uD83E\uDD1D",g:["kevin","jenna","madi","jack","emmy","jenna-mom","jenna-dad"],m:"crowd-survival",meals:["dinner","latenight"]}];
...
function TopBar(p){var isDark=p.theme==="dark"||(p.theme==="auto"&&typeof window!=="undefined"&&window.matchMedia&&!window.matchMedia("(prefers-color-scheme:light)").matches);var themeIcon=isDark?"🌙":"☀️";return <div style={{position:"relative",display:"flex",alignItems:"center",justifyContent:"space-between",padding:"8px 16px 5px",background:"var(--bg2)",borderBottom:"1px solid var(--bdr)"}}><div style={{display:"flex",alignItems:"center",gap:6,zIndex:1}}>{p.back&&<button onClick={p.back} style={{background:"none",border:"none",color:"var(--tx2)",fontSize:18,cursor:"pointer",padding:"2px 4px 2px 0",fontFamily:"inherit"}}>←</button>}<div onClick={p.onLogo} style={{cursor:p.onLogo?"pointer":"default"}}><div style={{fontSize:20,fontWeight:800,letterSpacing:-.8,lineHeight:1}}><span style={{color:"var(--ac)"}}>Jenna</span><span style={{color:"var(--tx1)"}}>rate</span></div><div style={{fontSize:7,fontWeight:1000,color:"var(--tx2)",marginTop:2,letterSpacing:1.8,textTransform:"uppercase",textAlign:"center",maxWidth:82}}>Food Logic</div></div></div><div style={{position:"absolute",left:0,right:0,textAlign:"center",pointerEvents:"none",padding:"0 90px"}}><div style={{fontSize:14,fontWeight:700,color:"var(--tx1)"}}>{p.title||""}</div>{p.sub&&<div style={{fontSize:12,color:"var(--tx3)",marginTop:1}}>{p.sub}</div>}</div><div style={{display:"flex",alignItems:"center",gap:14,zIndex:1}}>{p.onTheme&&<button onClick={p.onTheme} style={{background:"none",border:"none",padding:6,cursor:"pointer",fontSize:20,opacity:.7,lineHeight:1}}>{themeIcon}</button>}{p.onInfo?<button onClick={p.onInfo} style={{background:"none",border:"none",padding:6,cursor:"pointer",fontSize:20,lineHeight:1,filter:"drop-shadow(0 0 4px rgba(255,255,255,.15))"}}>{"ℹ️"}</button>:<div style={{width:20}}></div>}</div></div>;}
...
var mctx=getMealContext(mealOverride,customMealTimes);
  ...
  {aboutOpen&&(function(){var _abt=gs2.theme||"auto";var _abDk=_abt==="dark"||(_abt==="auto"&&window.matchMedia&&!window.matchMedia("(prefers-color-scheme:light)").matches);return <div style={{position:"fixed",top:0,left:0,right:0,bottom:0,zIndex:999,display:"flex",justifyContent:"flex-end"}}>
    ...
    <div className="slide-in" style={{position:"relative",width:"85%",maxWidth:340,background:_abDk?"linear-gradient(180deg,#0D1117 0%,#131920 40%,#161B22 100%)":"linear-gradient(180deg,#FAF0EC 0%,#F5E6E0 40%,#F0DDD6 100%)",height:"100%",overflow:"auto",boxShadow:_abDk?"-8px 0 40px rgba(0,0,0,.5)":"-8px 0 40px rgba(0,0,0,.12)",borderLeft:_abDk?"1px solid rgba(244,114,182,.08)":"1px solid rgba(200,150,130,.2)"}}>
      ...
      <div style={{padding:"0 20px"}}>
        ...
        <div style={{marginBottom:20}}>
          <div style={{display:"flex",alignItems:"center",gap:8,marginBottom:6}}><div style={{width:20,height:1,background:"#D4A574",opacity:.5}}></div><span style={{fontSize:10,fontWeight:700,color:"#D4A574",textTransform:"uppercase",letterSpacing:1.5}}>What it knows</span></div>
...
{/* HOME */}
  {vw==="dashboard"&&<div className="fade" style={{display:"flex",flexDirection:"column",height:"100dvh"}}>
    ...
    <div style={{flex:1,padding:"8px 16px 0",display:"flex",flexDirection:"column",gap:8,overflow:"auto"}}>
      ...
      {/* ── Hero CTA ── */}
      <button className="jfl-cta jfl-cta-hero" onClick={function(){go("step1");}}>
      ...
      <div className="jfl-card" style={{padding:"8px 10px"}}>
        ...
        {(function(){var mc=mctx;var src=qrCustom||QR_DEFAULTS;var visible=src.filter(function(q){return !q.meals||q.meals.length===0||q.meals.indexOf(mc.meal)>=0;});return visible.slice(0,4);})().map(function(q,i){return <button key={i} style={{display:"flex",alignItems:"center",justifyContent:"center",gap:6,padding:"7px 8px",borderRadius:8,border:"1px solid var(--bdr)",background:"var(--bg1)",cursor:"pointer",fontFamily:"inherit",textAlign:"center"}} onClick={function(){var hk=q.g.some(function(id){return kidIds.indexOf(id)>=0;});setSel(function(s){return Object.assign({},s,{sp:q.g,mood:q.m,kf:hk,go:q.g.length>4,xa:0,xk:0,qrLabel:q.l,qrEmoji:q.e});});go("qrConfirm");}}><span style={{fontSize:14}}>{q.e}</span><span style={{fontSize:12,fontWeight:600,color:"var(--tx2)"}}>{q.l}</span></button>;})}
        </div>
      </div>
  ...
  {vw==="history"&&<div className="fade" style={{display:"flex",flexDirection:"column",height:"100dvh"}}>
    ...
    <div style={{flex:1,padding:"10px 16px",overflow:"auto"}}>
      ...
      {sel.hf!=="rest"&&(function(){var list=rests.slice();if(sel.hf==="favs")list=list.filter(function(r){return r.fav;});else if(sel.hf==="active")list=list.filter(function(r){return!r.bo;});if(sel.hsort==="orders")list.sort(function(a,b){return b.to-a.to;});else if(sel.hsort==="recent")list.sort(function(a,b){var da=a.ld?new Date(a.ld).getTime():0;var db=b.ld?new Date(b.ld).getTime():0;return db-da;});else if(sel.hsort==="cuisine")list.sort(function(a,b){return(a.cat||"zzz").localeCompare(b.cat||"zzz")||a.name.localeCompare(b.name);});else list.sort(function(a,b){return a.name.localeCompare(b.name);});var totalOrders=list.reduce(function(s,r){return s+r.to;},0);
        ...
        {sel.hf==="insights"&&(function(){try{
          ...
          return <div className="fade">
            ...
            <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:8,marginBottom:12}}>
              ...
              <div className="jfl-card" style={{padding:"14px 12px",textAlign:"center"}}>
                <div style={{fontSize:28,fontWeight:800,color:"#D4A574"}}>{recent90}</div>
              ...
              <div className="jfl-card" style={{padding:"14px 12px",textAlign:"center"}}>
                <div style={{fontSize:28,fontWeight:800,color:"#D4A574"}}>{top5pct+"%"}</div>
        ...
        }catch(e){console.error("Insights error:",e);return <div className="jfl-card" style={{padding:16,textAlign:"center"}}><span style={{fontSize:11,color:"var(--tx3)"}}>Could not load insights</span></div>;}})()}
  ...
  return <div className="fade">
    <div style={{height:"100dvh",overflow:"auto",display:"flex",flexDirection:"column",background:"var(--bg0)"}}>
      ...
      <div style={{padding:"20px 24px 40px"}}>
        ...
        <button style={{width:"100%",padding:8,fontSize:12,fontWeight:500,marginTop:8,background:"none",border:"1px solid var(--bdr)",borderRadius:20,color:"var(--tx3)",cursor:"pointer",fontFamily:"inherit",opacity:.5}} onClick={function(){setH2hIntro(false);setH2H(null);setDisagrees(0);}}>{"Nevermind, go back"}</button>
      </div>
    </div>
  </div>;
}
...
setUplStatus("error");setUplMsg("Parse error: "+err.message);
}
};
reader.onerror=function(){setUplStatus("error");setUplMsg("Could not read file.");};
...
<input type="text" value={emIn||p.val} onChange={function(e){setEmIn(e.target.value);p.onChange(e.target.value);}} onFocus={function(){setEmIn(p.val);}} style={{width:40,padding:"4px 6px",borderRadius:6,border:"1px solid var(--bdr)",background:"var(--bg2)",color:"var(--tx1)",fontSize:20,textAlign:"center",fontFamily:"inherit"}}/>
...
<button onClick={function(){setPage("menu");setSelId(null);setSelPId(null);setSelGId(null);setSelQRIdx(null);setObvEditIdx(null);}} style={{background:"none",border:"none",color:"var(--tx2)",fontSize:18,cursor:"pointer",padding:"2px 4px 2px 0",fontFamily:"inherit"}}>{"←"}</button>
<div><div style={{fontSize:20,fontWeight:800,letterSpacing:-.8,lineHeight:1}}><span style={{color:"var(--ac)"}}>Jenna</span><span style={{color:"var(--tx1)"}}>rate</span></div><div style={{fontSize:7,fontWeight:1000,color:"var(--tx2)",marginTop:2,letterSpacing:1.8,textTransform:"uppercase",textAlign:"center",maxWidth:82}}>Food Logic</div></div>
</div>
...
<div style={{display:"flex",alignItems:"center",gap:14,zIndex:1}}>{props.onTheme&&<button onClick={props.onTheme} style={{background:"none",border:"none",padding:6,cursor:"pointer",fontSize:20,opacity:.7,lineHeight:1}}>{(function(){var _d=props.theme==="dark"||((!props.theme||props.theme==="auto")&&window.matchMedia&&!window.matchMedia("(prefers-color-scheme:light)").matches);return _d?"🌙":"☀️";})()}</button>}{props.onInfo?<button onClick={props.onInfo} style={{background:"none",border:"none",padding:6,cursor:"pointer",fontSize:20,lineHeight:1,filter:"drop-shadow(0 0 4px rgba(255,255,255,.15))"}}>{"ℹ️"}</button>:<div style={{width:20}}></div>}</div>
  ...
  {page==="menu"&&<div>
    ...
    <div style={{padding:"12px 16px 80px",display:"flex",flexDirection:"column",gap:8}}>
      {[
        ...
        {icon:"\u26A1",label:"Scoring Engine",sub:"Weights, toggles, global rules",pg:"engine"},
      ...
      <div style={{textAlign:"center",marginTop:12}}>
        <button style={{fontSize:10,padding:"6px 12px",color:factoryStep===2?"#ff2020":factoryStep===1?"var(--red)":"var(--tx3)",background:factoryStep===2?"rgba(255,20,20,.2)":factoryStep===1?"rgba(255,60,60,.1)":"none",border:factoryStep===2?"1px solid #ff2020":factoryStep===1?"1px solid var(--red)":"1px solid var(--bdr)",borderRadius:6,cursor:"pointer",fontFamily:"inherit",opacity:factoryStep?1:.5,transition:"all .2s",fontWeight:factoryStep===2?700:400}} onClick={function(){if(factoryStep===2){localStorage.removeItem(SK);window.location.reload();}else{setFactoryStep(function(s){return(s||0)+1;});setTimeout(function(){setFactoryStep(0);},6000);}}}>{factoryStep===2?"Last chance. Tap to erase everything permanently.":factoryStep===1?"Tap again to confirm \u2014 this erases everything":"Factory Reset"}</button>
      </div>
    </div>
  </div>}
...
".theme-light .jfl-card{border-color:#E0D0C5}",
