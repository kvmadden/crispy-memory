...
"@keyframes stepOn0{0%,5%{box-shadow:0 0 0 0 transparent,0 0 0 transparent}10%,78%{box-shadow:0 0 0 2px rgba(196,149,106,.55),0 0 14px rgba(196,149,106,.2)}92%,100%{box-shadow:0 0 0 0 transparent,0 0 0 transparent}}",
"@keyframes stepOn1{0%,24%{box-shadow:0 0 0 0 transparent,0 0 0 transparent}30%,78%{box-shadow:0 0 0 2px rgba(201,26,94,.45),0 0 12px rgba(201,26,94,.15)}92%,100%{box-shadow:0 0 0 0 transparent,0 0 0 transparent}}",
"@keyframes stepOn2{0%,48%{box-shadow:0 0 0 0 transparent,0 0 0 transparent}54%,78%{box-shadow:0 0 0 2px rgba(196,149,106,.5),0 0 14px rgba(196,149,106,.2)}92%,100%{box-shadow:0 0 0 0 transparent,0 0 0 transparent}}",
"@keyframes symFill1{0%,14%{opacity:0;transform:scale(.5)}20%{opacity:1;transform:scale(1.15)}24%,78%{opacity:1;transform:scale(1)}92%,100%{opacity:0;transform:scale(1)}}",
"@keyframes symFill2{0%,36%{opacity:0;transform:scale(.5)}42%{opacity:1;transform:scale(1.15)}46%,78%{opacity:1;transform:scale(1)}92%,100%{opacity:0;transform:scale(1)}}",
"@keyframes labelOn0{0%,5%{color:var(--tx3);text-shadow:none}10%,78%{color:var(--tx1);text-shadow:0 0 8px rgba(196,149,106,.25)}92%,100%{color:var(--tx3);text-shadow:none}}",
"@keyframes labelOn1{0%,24%{color:var(--tx3);text-shadow:none}30%,78%{color:var(--tx1);text-shadow:0 0 8px rgba(201,26,94,.2)}92%,100%{color:var(--tx3);text-shadow:none}}",
"@keyframes labelOn2{0%,48%{color:var(--tx3);text-shadow:none}54%,78%{color:var(--tx1);text-shadow:0 0 8px rgba(196,149,106,.2)}92%,100%{color:var(--tx3);text-shadow:none}}",
"@keyframes yumSparkle{0%,48%{filter:drop-shadow(0 0 0 transparent) drop-shadow(0 0 0 transparent)}54%{filter:drop-shadow(0 0 6px rgba(244,114,182,.3)) drop-shadow(0 0 16px rgba(196,149,106,.25))}60%,78%{filter:drop-shadow(0 0 10px rgba(244,114,182,.4)) drop-shadow(0 0 20px rgba(196,149,106,.3))}92%,100%{filter:drop-shadow(0 0 0 transparent) drop-shadow(0 0 0 transparent)}}",
