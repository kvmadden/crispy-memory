...
<div style={{display:"flex",alignItems:"center",gap:8,zIndex:1}}>{props.onTheme&&<button onClick={props.onTheme} style={{background:"none",border:"none",padding:2,cursor:"pointer",fontSize:14,opacity:.7}}>{(function(){var _d=props.theme==="dark"||((!props.theme||props.theme==="auto")&&window.matchMedia&&!window.matchMedia("(prefers-color-scheme:light)").matches);return _d?"🌙":"☀️";})()}</button>}{props.onInfo?<button onClick={props.onInfo} style={{background:"none",border:"none",padding:2,cursor:"pointer",fontSize:14,filter:"drop-shadow(0 0 4px rgba(255,255,255,.15))"}}>{"ℹ️"}</button>:<div style={{width:20}}></div>}</div>
...
".theme-light{--bg0:#F5E6E0;--bg1:#FAF0EC;--bg2:#F0DDD6;--bdr:#E0C4B8;--tx1:#2A1215;--tx2:#6B3A3A;--tx3:#9A7070;--ac:#C91A5E;--grn:#A07828;--yel:#B8860B;--red:#C0392B}",
...
"@keyframes stepOn0{0%,4%{box-shadow:0 0 0 0 transparent,0 0 0 transparent}8%,78%{box-shadow:0 0 0 2px rgba(244,114,182,.5),0 0 14px rgba(244,114,182,.2)}84%,100%{opacity:1;box-shadow:0 0 0 0 transparent,0 0 0 transparent}}",
"@keyframes stepOn1{0%,28%{box-shadow:0 0 0 0 transparent,0 0 0 transparent}34%,78%{box-shadow:0 0 0 2px rgba(244,114,182,.5),0 0 14px rgba(244,114,182,.2)}84%,100%{opacity:1;box-shadow:0 0 0 0 transparent,0 0 0 transparent}}",
"@keyframes stepOn2{0%,54%{box-shadow:0 0 0 0 transparent,0 0 0 transparent}60%,78%{box-shadow:0 0 0 2px rgba(244,114,182,.5),0 0 14px rgba(244,114,182,.2)}84%,100%{opacity:1;box-shadow:0 0 0 0 transparent,0 0 0 transparent}}",
"@keyframes lineFill1{0%,12%{background-size:0% 100%;opacity:1}28%,78%{background-size:100% 100%;opacity:1}88%,100%{background-size:100% 100%;opacity:0}}",
"@keyframes lineFill2{0%,38%{background-size:0% 100%;opacity:1}54%,78%{background-size:100% 100%;opacity:1}88%,100%{background-size:100% 100%;opacity:0}}",
