...
{/* HOME */}
  {vw==="dashboard"&&<div className="fade" style={{display:"flex",flexDirection:"column",height:"100dvh"}}>
    ...
    <div style={{flex:1,padding:"6px 16px 0",display:"flex",flexDirection:"column",gap:6,overflow:"auto"}}>
      ...
      {/* ── Quick Resolve ── */}
      {(function(){var mc=mctx;var src=qrCustom||QR_DEFAULTS;var visible=src.filter(function(q){return !q.meals||q.meals.length===0||q.meals.indexOf(mc.meal)>=0;}).slice(0,4);if(visible.length===0)return null;return <div className="jfl-card" style={{padding:"8px 10px"}}>
