...
{/* ═══ LANDING ═══ */}
  {vw==="landing"&&(function(){
    ...
    <div style={{flex:1,display:"flex",flexDirection:"column",justifyContent:"center",alignItems:"center",padding:"0 20px",position:"relative",zIndex:1,textAlign:"center",gap:12}}>
      ...
      {/* logo card */}
      <div style={{background:"rgba(255,255,255,.03)",backdropFilter:"blur(6px)",WebkitBackdropFilter:"blur(6px)",borderRadius:20,padding:"28px 28px 24px",width:"100%",maxWidth:340,border:"1px solid rgba(255,255,255,.08)"}}>
      ...
      {/* how-it-works card */}
      <div style={{background:"rgba(255,255,255,.03)",backdropFilter:"blur(6px)",WebkitBackdropFilter:"blur(6px)",borderRadius:20,padding:"20px 24px",width:"100%",maxWidth:340,border:"1px solid rgba(255,255,255,.08)"}}>
